...
<?php if ( have_comments() ) : ?>
	<h3><?php comments_number('No Responses', 'One Response', '% Responses');?> for "<?php the_title(); ?>"</h3>
...
<h3 class="title"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply for %s' ); ?></h3>
